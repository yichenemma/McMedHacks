...
First, using a CNN, our project aims at determining if X-ray images represent healthy patients or Covid-19 patients and propose this innovative method of Covid-19 detection. Second, we used Grad-CAM to determine which area of the CXR is essential for analyses.
